...
<html lang="es">
    <head>
        ...
        <title>Freelancer - Re-l Mayer</title>
        <!-- Favicon-->
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">Re-l Mayer</a>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class="masthead-avatar mb-5" src="https://pbs.twimg.com/media/EKpRzwWW4AAbMRC?format=jpg&name=360x360" style="border-radius: 50px;" alt="..." />
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Re-l Mayer</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Police - Esceptic - Robot</p>
            </div>
        </header>
        <!-- Portfolio Section-->
